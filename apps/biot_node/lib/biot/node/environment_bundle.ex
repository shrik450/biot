defmodule Biot.Node.EnvironmentBundle do
  ...
  @format 1
  @fields ["format", "closure_root", "entrypoint", "environment_file", "config_root"]

  @enforce_keys [:closure_root, :entrypoint, :environment_file, :config_root]
  defstruct [:closure_root, :entrypoint, :environment_file, :config_root]
